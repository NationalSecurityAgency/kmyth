...
static void proxy_usage(const char *prog)
{
  fprintf(stdout,
    ...
    "  -N or --remote-name     The functional name of the remote server to be used\n"
    "                          (along with the supplied IP or hostname) for constructing\n"
    "                          the name required to verify the server's certificate\n"
    "                              <IP address or hostname>.<functional name>\n"
    "                          Note: This is just a convention selected for this demo\n"
