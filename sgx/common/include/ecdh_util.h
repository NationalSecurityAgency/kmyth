 ...
 * 
 * @param[in]  client_eph_pubkey   Pointer to public key from the
 *                                 ephemeral (uniquely generated by the
 *                                 client for each session) elliptic curve
 *                                 key pair as an EC_KEY struct
 * 
 ...
 *
 * 
 * @param[in]  client_sign_pubkey     Pointer to EVP_PKEY formatted public key
 ...
 * 
 * @param[in]  server_eph_pubkey    Pointer to public key, as an EC_KEY
 *                                  struct, from the ephemeral (uniquely
 *                                  generated by the server for each
 *                                  session) elliptic curve key pair
 * 
 * @param[out] msg_out              Pointer to byte buffer containing the
 *                                  'Client Hello' message to be exchanged
 *                                  with a peer (e.g., key server)
